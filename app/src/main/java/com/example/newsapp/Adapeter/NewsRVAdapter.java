...
public class NewsRVAdapter extends RecyclerView.Adapter<NewsRVAdapter.ViewHolder> {
    ...
    Picasso.get().load(articles.getUrlToImage()).into(holder.newsTV);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("content",articles.getContact());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            titleTV=itemView.findViewById(R.id.txtNewsHeading);
            subTitleTV=itemView.findViewById(R.id.txtSubTitle);
            newsTV=itemView.findViewById(R.id.imageNews);
        }
    }
}
